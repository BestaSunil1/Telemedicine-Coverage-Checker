...
public class NotificationService {
	...
	public List<String> notifyDoctorOfNewAppointment(String doctorId, String appointmentId, String patientId) {
		Patient patient = patientRepository.findById(patientId).orElse(null);
		User patientUser = userRepository.findById(patient.getUser().getId()).orElse(null);
		String patientName = patient != null ? patientUser.getUsername() : "Unknown Patient";
		System.out.println("Patient Name: " + patientName);

		Notifications notification = new Notifications();
		Doctor doctor = doctorRepository.findById(doctorId).orElse(null);
		User doctorUser = userRepository.findById(doctor.getUser().getId()).orElse(null);
		System.out.println("Doctor Name: " + doctorUser.getUsername());
		...
		return List.of(doctorUser.getUsername(),patientName);
	}
//
	...
	public List<Notifications> getNotificationsForUser(String userId) {
