...
@Document(collection = "insurence_plans")
public class InsurencePlan {
	...
	public InsurencePlan() {
	}
	
	public InsurencePlan(String id, String planProvider, String planName, String planType, String planDescription,
			Integer planCost, boolean isActive) {
		super();
		this.id = id;
